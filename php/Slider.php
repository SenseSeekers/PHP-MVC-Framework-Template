...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <ol class="carousel-indicators">
  	<?php 
  		...
  		$resut_slider_icon=$DB->select($qry_slider_icon);
  		if($resut_slider_icon){
  			$i = 0 ;
  			while($data_slider_icon = $resut_slider_icon->fetch_array()){
  				?>
  ...
  <?php 
  	...
  	if($result_slider_img){
  		$i = 0;
  		while ($data_slider_image=$result_slider_img->fetch_array()){
  			?>
    <div class="item <?php if($data_slider_image['status']==1){ echo 'active'; } ?>">
      <img src="img/<?php echo $data_slider_image['image_url']; ?>" style="width:100%; height:250px;" alt="<?php echo $data_slider_img['image_url']; ?>">
    </div>
  		<?php
  		$i++;
  		}
...
<div class="jumbotron">
  ...
  <p style="font-size:12px; "><?php echo $data_site['welcome_body'];?></p>
