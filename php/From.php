<?php 
	if(isset($_POST['data_save'])){
		...
		if(empty($sender_email) OR empty($subject) OR empty($message)){
			$msg ='<apan style="color:red;">data not empty</span>';
		}else{
...
<form action="?page=Contact" method="post">
  ...
  <button name="data_save" type="submit" class="btn btn-info">Send</button>
 <?php if(isset($msg)){ echo $msg; } ?>
</form>
<!---->	
<div class="col-md-12" style="background:;margin-top:50px; margin-bottom:4px;">
	<img src="add/<?php if(isset($data_add)){echo $data_add['right_at'];}?>"  style="width:100%; height:400px; ">
</div>
	</div>
</section>
<!--------------------------------------------------------------------------->
